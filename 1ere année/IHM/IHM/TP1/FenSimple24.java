...
// Question 2.4
public class FenSimple24 extends JFrame {
	public FenSimple24 (String title, int x, int y, int w, int h ) {
	...
	public FenSimple24 (String title, int w, int h) {
		super(title); // Titre de la fen
	...
	public FenSimple24 (String title, int w, int h, Cursor c) {
		this(title, w, h);
		this.setCursor(c);
		this.setDefaultCloseOperation(EXIT_ON_CLOSE);
	}
	...
	public static void main(String[] args) {
		...
		int wt = ss.width;
		for (int i=1;i<=3;i++) {
			new FenSimple24("Fenêtre "+i, 0, (i-1)*ht, wt, ht);
		}
	}
}
